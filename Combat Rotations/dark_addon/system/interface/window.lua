...
dark_addon.on_ready(function()
  local engine = {
    ...
    template = {
      ...
      { type = 'rule' },
      { key = 'tickrate', type = 'spinner', text = 'Tick Rate', desc = 'The core ticket rate, in seconds.  Default is 0.1', min = 0.01, max = 1.00, step = 0.05, default = 0.1 },
      { key = 'gcd', type = 'checkbox', text = 'GCD Check', desc = 'Attempt to pause the rotation during the GCD.', default = true },
      { type = 'spacer' },
      { type = 'spacer' },
      { type = 'header', text = 'Turbo' },
      { type = 'rule' },
